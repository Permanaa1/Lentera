...
<h1 class="text-xl font-semibold mb-6">Edit Semester</h1>

<form method="POST" action="{{ route('admin.semesters.update', $semester) }}" class="bg-white p-6 rounded-lg shadow space-y-4 max-w-md">
    @csrf
    @method('PUT')
